...
multiXGBresult = pd.read_csv('multiXGB_test.csv',header=None,
	names=['shop_id','day_1','day_2','day_3','day_4','day_5','day_6','day_7'])

multiXGBresult['day_8'] = multiXGBresult['day_1']
multiXGBresult['day_9'] = multiXGBresult['day_2']
multiXGBresult['day_10'] = multiXGBresult['day_3']
multiXGBresult['day_11'] = multiXGBresult['day_4']
multiXGBresult['day_12'] = multiXGBresult['day_5']
multiXGBresult['day_13'] = multiXGBresult['day_6']
multiXGBresult['day_14'] = multiXGBresult['day_7']

print multiXGBresult.info()
...
result = pd.concat([multiXGBresult,avgresult],axis=0,ignore_index=True)
...
result.to_csv('m5multiXGB_150_{0}+avg1+w365-oct_sigma.csv'.format(len(multiXGBresult)),index=False,header=None,encoding = 'utf-8')
