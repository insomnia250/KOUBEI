...
GBDTresult = pd.read_csv('RF_test.csv',header=None,
...
result.to_csv('m4RF_150_{0}+avg1+w365-oct_sigma.csv'.format(len(GBDTresult)),index=False,header=None,encoding = 'utf-8')
