...
for i,shop in enumerate(uniqueshop):
	...
	score_merge2 = (np.abs( (merge2 - y)/ (merge2 + y))).sum()/7.0
	...
	SCORE_merge2.append(score_merge2)
	...
	# plt.plot(pd.date_range(start='20161026',end='20161026') ,paycount[(paycount['shop_id']==shop) &(paycount['time_stamp']==pd.datetime(2016,10,26)) ]['count'].values[0] ,'y',marker='o')
...
print 'SCORE_merge2:', np.mean(SCORE_merge2)