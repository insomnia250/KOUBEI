...
GBDTresult = pd.read_csv('gbdt_test.csv',header=None,
	names=['shop_id','day_1','day_2','day_3','day_4','day_5','day_6','day_7'])

GBDTresult['day_8'] = GBDTresult['day_1']
GBDTresult['day_9'] = GBDTresult['day_2']
GBDTresult['day_10'] = GBDTresult['day_3']
GBDTresult['day_11'] = GBDTresult['day_4']
GBDTresult['day_12'] = GBDTresult['day_5']
GBDTresult['day_13'] = GBDTresult['day_6']
GBDTresult['day_14'] = GBDTresult['day_7']

print GBDTresult.info()
...
result = pd.concat([GBDTresult,avgresult],axis=0,ignore_index=True)
...
result.to_csv('m4gbdt_150_{0}+avg1+w365-oct_sigma.csv'.format(len(GBDTresult)),index=False,header=None,encoding = 'utf-8')
