...
count['weekday'] = count['time_stamp'].dt.dayofweek 

shop = 1556
shopdata = count[(count['shop_id']==shop) & (count['weekday']==1)]




X = np.arange(len(shopdata)).reshape(-1,1)
y = shopdata['count'].values.reshape(-1,1)
# X= X[0:-1]
# y=y[0:-1]
