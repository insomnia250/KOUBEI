...
ARIMAresult = pd.read_csv('ARIMA_oripre77.csv',header=None,
...
result.to_csv('oriARIMA{0}+avg1+w365-oct_sigma.csv'.format(len(ARIMAresult)),index=False,header=None,encoding = 'utf-8')
